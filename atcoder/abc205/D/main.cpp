...
int32_t main()
{
	...
	int maxNum = *max_element(arr2, arr2 + q);
	int newRange = n + maxNum;
	vector <int> brandNewArray;
	for(int i = 1; i < newRange + 1; i++){
	...
	rep(t, q) {
		cout<<brandNewArray[arr2[t] - 1]<<endl;
	}

	// cout<<brandNewArray[2-1];
	// cout<<brandNewArray[5-1];
	// cout<<brandNewArray[3-1];
